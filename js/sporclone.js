...
function start()
{
    if (!playing)
    {
        ...
        // q.
        document.getElementById("time").style.color = "#33AA33";
...
function end()
{
    ...
    playing = false;
    // x.
    document.getElementById("time").style.color = "#FF3333";
    ...
    for (var i=0; i<is_guessed.length; i++)
    {
        ...
        {
        document.getElementById(id).style.backgroundColor = "#33DD33";
        }
        else
        {
...
/*picture topic= constellations*/
/*link for largest moons= http://www.ianridpath.com/moons.htm */